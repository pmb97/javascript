...
step 3: Define a variable called numberOfVowels and set its intial value to be equal to 0
...
for (numberOfVowels = 0; numberOfVowels < arrayOfLetters.length; numberOfVowels++){
  if (arrayOfVowels.includes(arrayOfLetters));
};
